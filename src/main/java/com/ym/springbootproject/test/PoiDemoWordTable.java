...
public class PoiDemoWordTable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "E://XDH/贵州反诈/Word文档生成/testResult.docx";  // 结果文件

        final String templateurl = "E://XDH/贵州反诈/Word文档生成/test.docx";  // 模板文件
    ...
    public static void doParagraphs(XWPFDocument doc) throws InvalidFormatException, IOException {
        ...
        imgMap.put("img", "C:\\Users\\Meng\\Pictures\\Camera Roll\\test.png");
